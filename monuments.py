...
monuments = [
    ...
    {'level': 7, 'name': 'Berlin TV Tower', 'options': ['Windsor Castle', 'Itsukushima Shrine', 'Temple Mount', 'Borobudur Temple', 'Seoul Tower', 'Sagrada Família']},
    ...
    {'level': 8, 'name': 'Grand Palace', 'options': ['Reichstag', 'Sacré-Cœur Basilica', 'Sagrada Família', 'Windsor Castle', 'Neuschwanstein Castle', 'Alhambra']},
    ...
    {'level': 9, 'name': 'Luxor Temple', 'options': ['Reichstag', 'Moai', 'Oriental Pearl Tower', 'Neuschwanstein Castle', 'Petra', 'Chapultepec Castle']},
